...
function Brand(){return <><a className="brand" href="#inicio" aria-label="Rutas Confiables, inicio"><img className="brand-logo" src="/favicon.png" alt="Logo oficial de Rutas Confiables"/><span className="header-brand-tagline">Transporte de pasajeros<br/>y tours</span></a><MainMenu/></>}
export default function Home(){return <main>
  <section className="hero" id="inicio"><nav><Brand/></nav><div className="hero-content"><p className="eyebrow">Transporte privado · Santiago de Chile</p><h1>Tu próxima ruta<br/>comienza aquí.</h1><p className="hero-copy">Descubre la nieve, viñedos, costa, montaña y experiencias únicas de Chile con un servicio cómodo, seguro y personalizado.</p><SafetyBadge/><div className="actions"><a className="button light" href="#experiencias">Ver destinos <span>→</span></a><a className="button ghost" href={whatsapp}>Solicitar cotización <span>→</span></a></div></div><div className="trust"><span>◇ <b>Transporte seguro</b><small>y confiable</small></span><span>♡ <b>Comodidad</b><small>en cada viaje</small></span><span>☆ <b>Experiencias</b><small>memorables</small></span></div></section>
...
import { Grape, Map, Mountain, MountainSnow, PawPrint, Users, Waves } from "lucide-react";
